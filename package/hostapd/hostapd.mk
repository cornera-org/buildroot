...
ifeq ($(BR2_PACKAGE_HOSTAPD_DBUS),y)
HOSTAPD_DEPENDENCIES += dbus
HOSTAPD_CONFIG_ENABLE += CONFIG_CTRL_IFACE_DBUS_NEW
HOSTAPD_LIBS += `$(PKG_CONFIG_HOST_BINARY) --libs dbus-1`
HOSTAPD_CFLAGS += `$(PKG_CONFIG_HOST_BINARY) --cflags dbus-1`
else
HOSTAPD_CONFIG_DISABLE += CONFIG_CTRL_IFACE_DBUS_NEW
endif
